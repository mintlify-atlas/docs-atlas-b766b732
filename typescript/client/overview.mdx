...
- See [Connecting Guide](/typescript/client/connecting) for browser usage
...
<CardGroup cols={3}>
  ...
  <Card title="WebSocketConnector" icon="bolt">
    WebSocket transport for bidirectional streaming (browser-only).
  </Card>
</CardGroup>
